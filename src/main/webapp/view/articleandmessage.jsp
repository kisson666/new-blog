...
<body>
<center>
    <%if ((int) (request.getAttribute("privatesee")) == 0) {%>
    <font color="red">文章内容</font><br>
    <% out.println(request.getAttribute("content"));%><br><br>
    <a href="#writemessage">点击给TA留言</a>
    <br><br>
    <font color="red">以下是留言</font><br>
    <%List<Message> messages = (List<Message>) request.getAttribute("messages"); %>
    <%!long i = 1; %>
    <%if (messages.isEmpty()) { %>
    <font color="red"><%out.println("暂时还没有人留言，你来座沙发吧！");%></font><br>
    <%} else { %>
    ...
    <font color="red">楼主的昵称:</font><a href="serchuser?id=<%=message.id%>"><%
    out.println(message.name + "  ");%></a><br><br><br><br><br>
    <%i++;%>
    <% }%>
    <%i = 1; %>
    <%} %>
    ...
    <%} else {%>
    <font color="red">您没有权限查看这篇文章</font><br>
    <%}%>
